...
//    }
    ...
    inner class DataTests(@Autowired mongoTemplate: MongoTemplate) {
        ...
        private var boxcarType: CarType? = TestAARTypeCreator.boxcarType(boxcarUUID)
        private var boxcarType2: CarType? = TestAARTypeCreator.getLoadedCarType(
            UUID.randomUUID(),
            AARDesignation.XM,
            listOfNotNull(GoodsType.Paper, GoodsType.Parts, GoodsType.Logs)
        )
        ...
        fun should_returnDistinct_AARDesignations() {
            ...
            //assert
            Assertions.assertThat(allCarTypes.size).isEqualTo(3)
            val expectedTypes = listOfNotNull(AARDesignation.XM, AARDesignation.FC, AARDesignation.GS)
        ...
        private fun insertCarTypesForTesting() {
            ...
            val gondola = TestAARTypeCreator.gondolaType()
            val flatcar = TestAARTypeCreator.flatcarType()
            val aarTypes = listOfNotNull(boxcar, gondola, flatcar)
